...
import com.imooc.miaoshaproject.Utils.JWTUtil;
...
//        }
    ...
    public CommonReturnType login(@RequestParam(name="telphone")String telphone,
        ...
        JWTUtil.sign(userModel);
        //将登陆凭证加入到用户登陆成功的session内
        this.httpServletRequest.getSession().setAttribute("IS_LOGIN",true);
        this.httpServletRequest.getSession().setAttribute("LOGIN_USER",userModel.getId());
        //redisTemplate.opsForValue().set(userModel.getId(),true,20,TimeUnit.SECONDS);
